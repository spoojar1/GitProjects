function b = help_check_intersect(p1,p2,p3,p4)
    ...
    load('workspace1.mat','Xc','Yc','Zc','fid','del','error');
    %----------------------------------------------
    fprintf(fid,'inside help check intersect \n');
    %----------------------------------------------
    b=0;
    ...
    t=min(t1);
    fprintf(fid,'min out of %d %d %d %d is %d \n',t1(1),t1(2),t1(3),t1(4),t);
    if(t>(del+error))
        return;
    end
    %}
    ...
    %----------------------------------------------
    fprintf(fid,'***********************************************************\n');
    fprintf(fid,'p1 %d p2 %d p3 %d p4 %d \n',p1,p2,p3,p4);
    %----------------------------------------------
  ...
  %}
    ...
    if(~isempty(a))
        ...
        if(double(a.s)>0 && double(a.s)<1 && double(a.t)>0 && double(a.t)<1)
            ...
            %----------------------------------------------
            fprintf(fid,'sad for this plane coz these lines p1 %d p2 %d p3 %d p4 %d \n',p1,p2,p3,p4);
            %----------------------------------------------
            ...
            %----------------------------------------------
            fprintf(fid,'p1 x %d y %d z %d \n',Xc(p1),Yc(p1),Zc(p1));
            fprintf(fid,'p2 x %d y %d z %d \n',Xc(p2),Yc(p2),Zc(p2));
            fprintf(fid,'p3 x %d y %d z %d \n',Xc(p3),Yc(p3),Zc(p3));
            fprintf(fid,'p4 x %d y %d z %d \n',Xc(p4),Yc(p4),Zc(p4));
            fprintf(fid,'intersection x %d y %d z %d \n',i1,i2,i3);
            %----------------------------------------------
